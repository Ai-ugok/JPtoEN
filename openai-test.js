  ...
  const messages = [
    {
      ...
      content:
        ...
        'あなたは問題の正誤判断をします。与えられた日本語の文章を英語に訳す際に、与えられた英語の文章が文法的に正しいかどうかを判断してください。正しい場合は「true」、間違っている場合は「false」と返答してください。また、falseの場合は、なぜ正しくないのか理由も示してください。副詞の位置が異なっていても、日本語の文章において強調している部分と合っていればtrueとしてください。ピリオドの前に空白があっても考慮しないでください。'
    },
    {
      role: 'user',
      content:
        ...
        '与えられた日本語の文章を英語に訳す際に、与えられた英語の文章が文法的に正しいかどうかを判断してください。正しい場合は「true」、間違っている場合は「false」と返答してください。日本語の文章は```私は主に検索するときにはGoogleを利用しています。```、英語の文章は```I use Google mainly when searching .```'
    },
    {
      role: 'assistant',
      content: 'false'
